 ...
 */
router.post('/meetings', meetingController_1.createMeeting);
/**
 * @swagger
 ...
 */
router.get('/users/:userId/available-slots', meetingController_1.getAvailableSlots);
/**
 * @swagger
 * /meetings/{meetingId}:
 *   put:
 ...
 *         description: Time slot already booked
 */
router.put('/meetings/:meetingId', meetingController_1.updateMeeting); // Update meeting endpoint
/**
 * @swagger
 * /meetings/{meetingId}:
 *   delete:
 ...
 */
router.delete('/meetings/:meetingId', meetingController_1.deleteMeeting); // Delete meeting endpoint
/**
 * @swagger
 * /users:
 *   get:
 ...
 */
router.get('/users/:userId/meetings', userController_1.getUserMeetings);
